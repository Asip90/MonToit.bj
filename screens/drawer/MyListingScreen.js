...
const styles = StyleSheet.create({
    ...
    listingPrice: { ...FONTS.h3, color: COLORS.primary, fontWeight: 'bold', marginBottom: 1 },
    listingTitle: { ...FONTS.body3, color: COLORS.black, marginBottom: 0},
    listingCategory: { ...FONTS.body4, color: COLORS.gray, marginBottom: 0 },
    availabilityContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: 0},
    availabilityLabel: { ...FONTS.body4, color: COLORS.darkGray, marginRight: 8 },
    listingFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 0, borderTopWidth: 1, borderTopColor: COLORS.lightGray, paddingTop: 10 },
